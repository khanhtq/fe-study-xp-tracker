...
export default function PublicProfileModal({ userId, onClose }) {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto scrollbar-thin">
        <motion.div
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 rounded-full bg-slate-950/60 text-slate-400 hover:text-white hover:bg-slate-950 transition-all border border-slate-800"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          {loading ? (
            ...
            <div className="p-8 text-center">
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-xl bg-slate-800 text-slate-200 text-sm font-medium hover:bg-slate-700 transition-colors"
              >
                {t('close')}
              </button>
            </div>
            ...
            <div>
              {/* Header Cover Banner */}
              <div className="h-28 bg-gradient-to-r from-indigo-900/60 via-purple-900/40 to-slate-900/80 relative border-b border-slate-800/80 overflow-hidden">
                <div className="absolute -top-12 -left-12 w-40 h-40 bg-indigo-500/20 rounded-full blur-3xl" />
                <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/15 rounded-full blur-3xl" />
              </div>
              ...
              <div className="px-6 pb-6 pt-0 relative">
                <div className="flex justify-between items-end -mt-12 mb-4">
                  ...
                  <div className="relative">
                    {profile.avatarUrl && !imgErr ? (
                      ...
                      <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-indigo-900 to-purple-950 border-4 border-slate-900 shadow-xl flex items-center justify-center font-black text-2xl text-indigo-200">
                        {initials}
                      </div>
                    )}
                  ...
                  <div className="flex flex-col items-end gap-1">
                    <span className="px-3.5 py-1 rounded-xl bg-gradient-to-r from-amber-500/20 to-indigo-500/20 border border-amber-500/30 text-amber-300 font-extrabold text-xs flex items-center gap-1 shadow-sm">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center gap-1.5 mt-1 text-xs font-semibold text-indigo-400">
                ...
                <div className="grid grid-cols-2 gap-3 mb-5">
                  <div className="p-3.5 rounded-2xl bg-slate-950/50 border border-slate-800/80 flex items-center gap-3">
